        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-4xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p
              ...
              data-aos="fade-up"
              data-aos-delay="200">
              1000 sq ft • ${props.parcel.price_per_1000sqft} USD
            </p>
          </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">About this property</h2>
            <p className="text-xl text-gray-400">
              Leave civilization behind and create your new happy place on this
              remote lot north of Joseph City. This property has no nearby
              neighbors so you will have the freedom to live life your way here.
              Access is from an unmaintained dirt road, so bring your four-wheel
              drive and your sense of adventure. The terrain is flat other than
              one small wash crossing the northeast corner, and the property is
              not in a flood zone. With wide-open spaces in every direction, you
              will have plenty of space for all your friends and family.
            </p>
          </div>
          ...
          <div
            ...
            <div
              ...
              <h4 className="h4 mb-2">Your space</h4>
              <p className="text-lg text-gray-400 text-center">
                Your contract can't be voided or cancelled, and it never
                expires. Even if Pocket isn't around in the far future, you can
            ...
            <div
              ...
              <h4 className="h4 mb-2">Instant Access</h4>
              <p className="text-lg text-gray-400 text-center">
                Camp, build, and explore. Buy now and get instant access to this
                parcel of land.
              </p>
            </div>
            ...
            <div
              ...
              <h4 className="h4 mb-2">One time payment</h4>
              <p className="text-lg text-gray-400 text-center">
                You pay once, and the land is yours. Don't worry about taxes,
            ...
            <div
              ...
              <h4 className="h4 mb-2">Zoning and Allowed Usage</h4>
              <p className="text-lg text-gray-400 text-center">
                You're allowed to use the space to the fullest, including
                camping & building, provided it is within the confines of the
                county zoning restrictions. <br />
                • Structures <br />
                • Commercial Use <br />
                • Legal Access <br />
              </p>
            ...
            <div
              ...
              <h4 className="h4 mb-2">Land Usage Agreement</h4>
              <p className="text-lg text-gray-400 text-center">
                • 99-year full usage rights <br />
                • Property secured in trust
                <br />
                • Pay once, no additional taxes or fees
                <br />
                • Sell this contract anytime
                <br />
                • Earn legal title at a later date
                <br />
              </p>
            </div>
            ...
            <div
              ...
              <h4 className="h4 mb-2">Invest and Earn</h4>
              <p className="text-lg text-gray-400 text-center">
                Buy this parcel today and hold onto it. Resell it any time for
                any price. Increase value with a structure or lot improvement.
              </p>
            </div>
          </div>
        </div>
...
export default function Order() {
  ...
  const createOrder = useMutation("ordering:createOrder");
  const generateOrder = () =>
    createOrder(
      email,
      "",
  ...
  function sendInvoice(){
    const options = {
      ...
      body: JSON.stringify({
        amount: parcel.price_per_1000sqft,
        description: 'Payment for Pocket Plot Land',
        name: 'Pocket Plots',
        recipient: email
      })
    };
  ...
  if (parcel.city === undefined)
    ...
    const showInMapClicked = () => {
      window.open(
        "https://maps.google.com?q=" + parcel.lat + "," + parcel.long
      );
    };
        ...
        <Fade>
          ...
          <main className="grow">
            ...
            <Box
              ...
              alignItems="center"
              marginTop="15px">
              <Button href="/about">Questions?</Button>
            </Box>
            <Features />
            <Testimonials />
            <ParcelList />
          ...
          <Fade in={open}>
            <Box sx={style}>
              <Typography
                ...
                variant="h6"
                component="h2">
                Enter email for Checkbook Invoice
              </Typography>
              <Typography id="transition-modal-description" sx={{ mt: 2 }}>
                By filling out this form, you agree to our terms of service.
              </Typography>
              <Box marginTop="20px">
                <TextField
                  variant="outlined"
